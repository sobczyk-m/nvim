...
require('lazy').setup({
  ...
  -- { import = 'custom.plugins' }, - imporst all plugins from folder
  -- Github copilot
...
vim.keymap.set('n', '<leader>sp', require('telescope.builtin').spell_suggest, { desc = '[S]earch new [P]hrase' })
